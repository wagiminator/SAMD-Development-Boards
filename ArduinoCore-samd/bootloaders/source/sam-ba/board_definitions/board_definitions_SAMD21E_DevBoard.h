...
#define STRING_MANUFACTURER "Wagiminator"
#if (SAMD21)
  #define STRING_PRODUCT "SAMD21E DevBoard"
#elif (SAML21)
  #define STRING_PRODUCT "SAMD21E DevBoard L21"
#elif (SAMC21)
  #define STRING_PRODUCT "SAMD21E DevBoard C21"
#endif
